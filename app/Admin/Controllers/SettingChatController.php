...
class SettingChatController extends AdminController
{
    ...
    protected function grid(): Grid
    {
        ...
        $grid->column('first_img', __('邮箱绑定引导图'))->image();
        $grid->column('second_ios_img', __('操作流程引导图'))->image();
    ...
    protected function form(): Form
    {
        ...
        $form->image('first_img', __('邮箱绑定引导图'))->required();
        $form->textarea('email_text', __('邮箱绑定引导话术'))->required();

        $form->image('second_ios_img', __('操作流程引导图'))->required();
